...
public class CreativeTab {
    public static final DeferredRegister<CreativeModeTab> TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, NumismaticsUtils.MODID);

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> NUMISMATICS_UTILS_TAB = TABS.register(
            "numismatics_utils_tab",
            () -> CreativeModeTab.builder()
                    .icon(() -> new ItemStack(ItemRegistry.BANK_METER.get()))
