...
public class ItemRegistry {
    ...
    public static final DeferredItem<BankMeterItem> BANK_METER = ITEMS.register("bank_meter",
            () -> new BankMeterItem(new Item.Properties().stacksTo(1)));

    public static final DeferredItem<PortableBankTerminalItem> PORTABLE_BANK_TERMINAL = ITEMS.register("portable_bank_terminal",
            () -> new PortableBankTerminalItem(new Item.Properties().stacksTo(1)));
}
